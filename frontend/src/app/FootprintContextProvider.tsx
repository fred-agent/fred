...
export const FootprintContextProvider = (props: PropsWithChildren<{}>) => {
  ...
  const contextValue: FootprintContextStruct = useMemo(
    ...
    [
      period,
      currentClusterFootprints,
      selectedClusterFootprints,
      allClusterFootprints,
      currentCarbonConsumption,
      currentEnergyConsumption,
      currentCostConsumption,
    ],
  );
  ...
  const fetchClustersFootprint = debounce(() => {
    ...
    getClusterFootprints({ start: startDate, end: endDate }).then((response) => {
