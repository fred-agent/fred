            ...
            <Grid2 container justifyContent="center" alignItems="center" spacing={2}>
                ...
                <Grid2 size={5} container justifyContent="right">
                    <Typography 
                        variant="h5"
                        align="center">
                        {clusters.map(cluster => cluster.value).reduce((sum, value) => sum + value, 0).toLocaleString()} {unit}
                    </Typography>
                </Grid2>
                            ...
                            <Grid2 pt={1}>
                                <Grid2 container size={{ xs:12 }} justifyContent="flex-end" pr={2}>
                                    <ToggleButtonGroup
                                        value={chart}
                                        exclusive
                                        onChange={handleChartSerieChange}
                                    >
                                        {chartOptions.map((chartOption) => (
                                            <ToggleButton
                                                ...
                                                sx={{
                                                    ...
                                                    height: '24px',
                                                    borderRadius: '10px',
                                                    backgroundColor: chartOption === chart ? theme.palette.primary.main : theme.palette.primary.light,
                                                ...
                                                <Table sx={{ height: '100%' }}>
                                                    <TableHead>
                                                        <TableRow>
                                                            ...
                                                            <TableCell align="center">{title} ({unit})</TableCell>
                                                            <TableCell align="center">%</TableCell>
                                                        </TableRow>
                                                    </TableHead>
                                                    <TableBody>
                                                        {clusters.sort((a, b) => b.value - a.value).map((cluster) => (
                                                            <TableRow key={cluster.alias}>
                                                                ...
                                                                <TableCell align="center">
                                                                    {(cluster.value * 100 / clusters.map(c => c.value).reduce((sum, value) => sum + value, 0)).toFixed(2)}
                                                                </TableCell>
                                                            </TableRow>
                                                        ))}
                                                    </TableBody>
