...
export default function Sources({
  ...
  return (
    <>
        ...
        >
          ...
          >
            <Box sx={{ display: "flex", alignItems: "center", gap: 1 }}>
              ...
              <Typography variant="h6">All Sources ({sources.length})</Typography>
            </Box>
      ...
      <DocumentViewer document={fullDocument} open={documentViewerOpen} onClose={handleCloseDocumentViewer} />
    </>
  );
}
