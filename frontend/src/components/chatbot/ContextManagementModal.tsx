...
import { Box, Typography, Modal, Button, IconButton, Alert, CircularProgress } from "@mui/material";
...
} from "../../slices/agentContextApi";

/**
 * Modal component for managing context cards of an agent using Minio backend
 */
const ContextManagementModal = ({ open, onClose, agent, getAgentBadge }) => {
  ...
  const loadContexts = async () => {
    ...
    try {
      ...
      const entries = Object.entries(response.context || {}).map(([id, data]) => ({
        id,
                  ...
                  <Box
                    sx={{
                      ...
                      backgroundColor: isDarkTheme
                        ? theme.palette.chart.alterningBgColor1
                        : theme.palette.chart.alterningBgColor2,
                      borderRadius: 2,
                    }}
                  >
