                 ...
                 <Box
                   ...
                   sx={{
                     ...
                     backgroundColor: isSelected
                       ? isDarkTheme ? 'rgba(25, 118, 210, 0.12)' : 'rgba(25, 118, 210, 0.05)'
                       : isDarkTheme ? 'rgba(255,255,255,0.03)' : 'rgba(0,0,0,0.02)',
                     transition: 'all 0.2s',
                     '&:hover': {
                       backgroundColor: isSelected
                         ? isDarkTheme ? 'rgba(25, 118, 210, 0.15)' : 'rgba(25, 118, 210, 0.08)'
                         : isDarkTheme ? 'rgba(255,255,255,0.05)' : 'rgba(0,0,0,0.04)',
                     }
                   }}
                 >
                   <Box sx={{ mr: 2 }}>
