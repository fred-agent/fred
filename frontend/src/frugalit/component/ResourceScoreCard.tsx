...
export const ResourceScoreCard = ({ name, score }: ResourceIdentityCardProps) => {
      ...
      {!isSmallScreen && (
        ...
        >
          <Box sx={{ width: "100%", height: "100%" }}>
            <ResourceScoreSimpleRadarChart zoom={"50%"} application_name={name} data={radarChartData} unit={"/100"} />
          </Box>
        </Grid2>
      )}
    </Box>
