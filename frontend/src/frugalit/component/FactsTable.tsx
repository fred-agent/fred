...
const FactsTable = ({ hexData, selectedFact, setSelectedFact }) => {
  ...
  // Paginated data
  const paginatedData = hexData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage);
      ...
      <Table stickyHeader size="small">
        ...
        <TableBody>
          {paginatedData.map(({ fact }, index) => (
            ...
            >
              <TableCell>
                <Typography variant="body2">{fact.title}</Typography>
              </TableCell>
              <TableCell>
                <Typography variant="body2">{fact.user}</Typography>
              </TableCell>
              <TableCell
                sx={{
