...
const extendedApi = apiSlice.injectEndpoints({
  endpoints: (builder) => ({
    ...
    getCarbonConsumption: builder.mutation<
      ClusterConsumption,
      {
        start: string;
        end: string;
    ...
    getEnergyConsumption: builder.mutation<
      ClusterConsumption,
      {
        start: string;
        end: string;
    ...
    getFinopsCost: builder.mutation<
      ClusterConsumption,
      {
        start: string;
        end: string;
    ...
    GetWorkloadSummary: builder.mutation<
      WorkloadSummary,
      {
        cluster: string;
        namespace: string;
    ...
    GetClusterSummary: builder.mutation<
      ClusterSummary,
      {
        cluster: string;
      }
    ...
    GetNamespaceSummary: builder.mutation<
      NamespaceSummary,
      {
        cluster: string;
        namespace: string;
    ...
    GetWorkloadEssentials: builder.mutation<
      WorkloadEssentials,
      {
        cluster: string;
        namespace: string;
    ...
    GetWorkloadAdvanced: builder.mutation<
      WorkloadAdvanced,
      {
        cluster: string;
        namespace: string;
    ...
    GetWorkloadId: builder.mutation<
      WorkloadId,
      {
        cluster: string;
        namespace: string;
    ...
    GetWorkloadScore: builder.mutation<
      WorkloadScores,
      {
        cluster: string;
        namespace: string;
    ...
    GetWorkloadFacts: builder.mutation<
      FactList,
      {
        cluster: string;
        namespace: string;
    ...
    postWorkloadFacts: builder.mutation<
      Fact,
      {
        cluster: string;
        namespace: string;
    ...
    postClusterFacts: builder.mutation<
      Fact,
      {
        cluster: string;
        fact: Fact;
    ...
    postNamespaceFacts: builder.mutation<
      Fact,
      {
        cluster: string;
        namespace: string;
    ...
    deleteWorkloadFacts: builder.mutation<
      void,
      {
        cluster: string;
        namespace: string;
    ...
    deleteNamespaceFacts: builder.mutation<
      void,
      {
        cluster: string;
        namespace: string;
    ...
    deleteClusterFacts: builder.mutation<
      void,
      {
        cluster: string;
        fact: Fact;
