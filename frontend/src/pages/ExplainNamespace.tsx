...
import { NamespaceCard } from '../components/NamespaceCard.tsx';
    ...
    return (
        <PageBodyWrapper>
            <Box
                ...
                minHeight="50vh"
            >
                <NamespaceCard cluster={currentClusterOverview} factList={namespaceFacts} summary={namespaceSummary} namespace={namespace} />
            </Box>
        </PageBodyWrapper>
    );
};
