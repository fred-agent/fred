...
You can use Kubernetes annotations to attach arbitrary non-identifying metadata object. Clients such as tools and libraries can retrieve this metadata.
...
- User or tool/system provenance information, such as URLs of related objectsfrom other ecosystem components.
